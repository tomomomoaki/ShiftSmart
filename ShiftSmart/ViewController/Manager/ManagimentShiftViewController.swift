...
class ManagimentShiftViewController: UIViewController,FSCalendarDataSource,FSCalendarDelegate,FSCalendarDelegateAppearance {
    ...
    private func fetchEventsInfoFromFirestore() {
        ...
        Firestore.firestore().collection("Events").document(date).collection("shifts")
...
extension ManagimentShiftViewController: UITableViewDelegate,UITableViewDataSource {
